...
export const platformService = {
    ...
    async create(params: AddParams): Promise<Platform> {
        ...
        const newPlatform: NewPlatform = {
            ...
            filteredPieceNames: [],
            enforceAllowedAuthDomains: false, // This is important - keeps it false
            allowedAuthDomains: [], // Keep empty to allow all domains
            filteredPieceBehavior: FilteredPieceBehavior.BLOCKED,
            showPoweredBy: false,
            ssoEnabled: false, // This is important - keep it false
